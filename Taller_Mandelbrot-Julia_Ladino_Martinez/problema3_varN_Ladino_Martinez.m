...
D = zeros(size(A));
%% variable de video
v = VideoWriter('set_Julia_con_n_diferentes.avi'); %creamos un objeto 'v' donde se almacenar�n las im�genes que conforman el video
...
for n = 1:15 % variacion de c
    ...
    imagesc(D)
    title("Set de Julia con n = " + num2str(n) + " y c = 0.5")
    xlabel('Eje Real')
